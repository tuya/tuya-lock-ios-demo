...
#import <TYEncryptImage/UIImageView+TYAESImage.h>
...
- (void)reloadData:(NSDictionary *)data{
    ...
    [self.imageIconView ty_setImageWithURL:[NSURL URLWithString:avatarUrl]];
