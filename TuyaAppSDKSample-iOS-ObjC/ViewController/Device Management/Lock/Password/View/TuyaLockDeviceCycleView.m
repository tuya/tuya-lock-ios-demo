...
#import <TuyaSmartLockKit/TuyaSmartLockUtil.h>
...
- (void)reloadData:(NSDictionary *)data{
    ...
    NSString *bin_workingDay = [TuyaSmartLockUtil getBinaryByDecimal:workingDay];
...
- (TuyaSmartBLELockScheduleList *)getScheduleListModel{
    TuyaSmartBLELockScheduleModel *scheduleModel = [[TuyaSmartBLELockScheduleModel alloc] init];
    //16进制转成10进制
