...
#import <TuyaSmartLockKit/TuyaSmartBLELockScheduleModel.h>
...
- (void)viewDidLoad {
    ...
    self.bleDevice = [TuyaSmartBLELockDevice deviceWithDeviceId:self.devId];
...
#pragma mark - TuyaSmartBLELockDeviceDelegate

- (void)device:(TuyaSmartBLELockDevice *)device didReceiveCreatePasswordMessage:(TuyaSmartBLELockPasswordModel *)model{
    NSLog(@"");
}

- (void)device:(TuyaSmartBLELockDevice *)device didReceiveModifyPasswordMessage:(TuyaSmartBLELockPasswordModel *)model{
    NSLog(@"");
}

- (void)device:(TuyaSmartBLELockDevice *)device didReceiveDeletePasswordMessage:(TuyaSmartBLELockPasswordModel *)model{
    NSLog(@"");
}
