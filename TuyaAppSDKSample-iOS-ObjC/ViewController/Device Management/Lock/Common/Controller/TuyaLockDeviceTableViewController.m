...
@interface TuyaLockDeviceTableViewController ()<TuyaSmartHomeDelegate,UITableViewDelegate,UITableViewDataSource>
...
- (void)selectLockDevice:(NSArray <TuyaSmartDeviceModel *> *)deviceList{
    for (TuyaSmartDeviceModel *model in deviceList) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TuyaSmartDeviceModel *model = self.devicelist[indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    TuyaSmartDeviceModel *model = [self.devicelist objectAtIndex:indexPath.row];
