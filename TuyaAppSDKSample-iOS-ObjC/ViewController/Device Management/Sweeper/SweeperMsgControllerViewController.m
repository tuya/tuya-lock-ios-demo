...
#import <TYFoundationKit/NSData+TYStringEncoding.h>
#import <TYFoundationKit/NSString+TYHex.h>

@interface SweeperMsgControllerViewController ()<TuyaSmartHomeDelegate,UITableViewDelegate,UITableViewDataSource>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    TuyaSmartDeviceModel *model = [self.devicelist firstObject];
